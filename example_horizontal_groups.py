...
_buttons: CTkButtonGroup = CTkButtonGroup(
    _root, commands=_commands, gutter=5, arrangement="HORIZONTAL"
)
...
_checkBoxes: CTkCheckBoxGroup = CTkCheckBoxGroup(
    _root, options=_options, command=handleCheckBox, gutter=10, arrangement="HORIZONTAL"
)
_checkBoxes.grid(row=1, column=0, padx=10, pady=10, sticky="nwe")  # type: ignore
...
_radioButtons.grid(row=2, column=0, padx=10, pady=10, sticky="nwe")  # type: ignore
...
_switches: CTkSwitchGroup = CTkSwitchGroup(
    _root, options=_options, command=handleSwitch, gutter=5, arrangement="HORIZONTAL"
)
_switches.grid(row=3, column=0, padx=10, pady=10, sticky="nwe")  # type: ignore
